...
e.stopPropagation();
    ...
    return (
        ...
        <div onClick={handleDashboardHelp} className="border-2 w-[50%] bg-white rounded-md border-white absolute top-1/2 transform -translate-y-1/2 left-1/2 transform -translate-x-1/2 p-4 shadow-lg p-6  rounded-md shadow-md">
...
<FaTimes onClick={props.valueHelp} className='border-2 ml-auto rounded-full border-white cursor-pointer hover:bg-gray-300  p-2 text-[35px] transition-bg duration-300 ease-in-out'/>
  ...
  <h2 className="text-2xl font-bold mb-4">Help and Resources</h2>
  <p className="text-base text-gray-600">
    Welcome to your Dashboard! Here's some helpful information:
  </p>

  <div className="mt-4">
    <h3 className="text-xl font-semibold">Navigating the Dashboard</h3>
