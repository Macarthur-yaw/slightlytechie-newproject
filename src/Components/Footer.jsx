...
const Footer = () => {
  ...
  return (
    <div className={`text-center py-4 px-8 md:justify-around inline-flex justify-between text-[10px] md:text-[14px] ${theme ? 'bg-[#121212] text-white' : 'bg-white text-black'}`}>
